...
save = True
save_files = "/home/stewart/plaintext/animation-{0:05d}.png"
...
shape_groups = {}
shapes = {
    'message1': AnimText ("My username is: test", (280, 150), fontsize=40, fontname="monospacetypewriter", mode="typewriter", hide=False),
    'message2': AnimText ("My password is: plaintext123", (280, 210), fontsize=40, fontname="monospacetypewriter", mode="typewriter", hide=False),
}
...
def animate():
    # Add animations here
    shapes['message1'].typewriter_tween(50, 200, frame)
    shapes['message2'].typewriter_tween(250, 400, frame)
    shapes['message1'].move_rel_tween(600, 800, frame, (2000,0))
    shapes['message2'].move_rel_tween(600, 800, frame, (2000,0))
